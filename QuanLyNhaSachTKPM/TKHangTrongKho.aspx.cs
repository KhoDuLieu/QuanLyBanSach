...
public partial class TKHangTrongKho : System.Web.UI.Page
{
    ...
    {
        string sql = "";
        if (ddtSapXep.SelectedValue == "0") sql = "select * from SACH order by Soluong";//hiển thị theo số lương tăng dần
        else sql = "select * from SACH order by Soluong desc";//ngược lại giảm dần
