...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%;">
        <tr>
            <td class="auto-style1">Nhà xuất bản:</td>
        ...
        <tr>
            <td class="auto-style1">Thể loại:</td>
            <td class="auto-style5">
        ...
        <tr>
            <td class="auto-style1">Tác giả</td>
            <td class="auto-style5">
...
&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" OnRowDeleting="GridView1_RowDeleting" DataKeyNames="MaSach" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5" OnRowCommand="GridView1_RowCommand" >
        <Columns>
            <asp:TemplateField HeaderText="STT">
                <ItemTemplate><%#get_stt() %></ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Mã sách" InsertVisible="False">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="">
                <ItemTemplate> 
                    <asp:LinkButton ID="Button1" runat="server" CommandName="CapNhat" CommandArgument='<%# Eval("MaSach") %>'
