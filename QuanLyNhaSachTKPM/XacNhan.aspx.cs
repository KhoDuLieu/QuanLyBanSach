    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["Cart"] != null)
            {
                ...
                if (Session["DiaChi"] != null && Session["HoTen"] != null && Session["TINH_THANHPHO"] != null && Session["QUAN_HUYEN"] != null && Session["PHUONG_XA"] != null &&
                    Session["SDT"] != null && Session["Email"] != null)
                {
                    ...
                    lblProvince.Text = Session["TINH_THANHPHO"].ToString();
                    lblDistrict.Text = Session["QUAN_HUYEN"].ToString();
                    lblWard.Text = Session["PHUONG_XA"].ToString();
                ...
                else
                {
                    ...
                    lblProvince2.Text = Session["TINH_THANHPHO"].ToString();
                    lblDistrict2.Text = Session["QUAN_HUYEN"].ToString();
                    lblWard2.Text = Session["PHUONG_XA"].ToString();
    ...
    protected void btnXacNhan_Click(object sender, EventArgs e)
    {
        ...
        if (cc.UserValidated)
        {
            ...
            if (i > 0)
            {
                ...
                {
                    hd.MaSach = int.Parse(dr["ID"].ToString());
