...
public class TaiKhoanBLL
{
    ...
    public int dangKy(TaiKhoanInfo tk)
    {
        ...
        SqlParameter[] par = new SqlParameter[]{
            ...
            new SqlParameter("@quan",SqlDbType.NVarChar),
            new SqlParameter("@phuong",SqlDbType.NVarChar),
        ...
        par[4].Value = tk.SDT;
        par[5].Value = tk.TINH_THANHPHO;
        par[6].Value = tk.QUAN_HUYEN;
        par[7].Value = tk.PHUONG_XA;
    ...
    public IList showUserinfo()
    {
        ...
        while (dr.Read())
        {
            ...
            if (!dr.IsDBNull(6)) hh.TINH_THANHPHO = dr.GetString(6);
            if (!dr.IsDBNull(7)) hh.QUAN_HUYEN = dr.GetString(7);
            if (!dr.IsDBNull(8)) hh.PHUONG_XA = dr.GetString(8);
    ...
    public bool updateUser(TaiKhoanInfo ti)
    {
        ...
        par[1].Value = ti.TINH_THANHPHO;
        par[2].Value = ti.QUAN_HUYEN;
        par[3].Value = ti.PHUONG_XA;
