<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="TheLoai.aspx.cs" Inherits="TheLoai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%;">
        <tr>
            <td class="auto-style1">Tên thể loại</td>
            <td class="auto-style5">
                <asp:TextBox ID="txtTenTL" runat="server" Width="320px"></asp:TextBox>
            </td>
            <td>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTenTL" Display="Dynamic" ErrorMessage="* Nhập thể loại" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
